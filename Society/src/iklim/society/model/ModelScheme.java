...
public class ModelScheme {
	...
	public static final String PropertyInventorySize		= "inventorySize";

	public static final String PropertyArea					= "area";
	public static final String PropertyWork					= "work";
	public static final String PropertyFieldSize			= "fieldSize";
	public static final String PropertyBuildable			= "buildable";
	public static final String PropertyTo					= "to";
	public static final String PropertyType					= "type";
	public static final String PropertyInitValue			= "initValue";
	public static final String PropertyWorker				= "worker";
	public static final String PropertyTarget				= "target";
	public static final String PropertyTargetValue			= "targetValue";
	public static final String PropertyResult				= "result";
	public static final String PropertyLevel				= "level";
	public static final String PropertyMultiplier			= "multiplier";
